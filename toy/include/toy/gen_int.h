...
#ifndef TOY_TOY_INCLUDE_GEN_INT_H
#define TOY_TOY_INCLUDE_GEN_INT_H
...
#define TOY_GEN_INT_STATE
#define TOY_GEN_INT_INIT(s)
#define TOY_GEN_INT_DESTROY(s)
...
#endif /* TOY_TOY_INCLUDE_GEN_INT_H */
